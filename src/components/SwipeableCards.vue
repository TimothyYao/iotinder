...
export default {
  ...
  data() {
    return {
      ...
      cards: [
        { src: 'adcthermostat.jpg', name: 'ADC Thermostat', age: 2 },
        { src: 'yale.jpg', name: 'Yale Lock', age: 5 },
        { src: 'echo.jpg', name: 'Alexa', age: 18 },
        { src: 'doorbellcamera.jpg', name: 'Doorbell Camera', age: 12 },
        { src: 'yeelight.jpg', name: 'Yeelight WIFI LED Bulb', age: 1 },
        { src: 'nestthermostat.webp', name: 'NEST Thermostat', age: 7 },
        { src: 'drone.jpg', name: 'Drone', age: 100 },
        { src: 'iq2.jpg', name: 'Qolsys IQ 2', age: 6 },
      ],
    };
  },
  computed: {
...
.header {
  ...
  background: #f9b153;
  background: -webkit-linear-gradient(to top, #b9561d, #f99e53);
  background: linear-gradient(to top, #b94e1d, #f99e53);
